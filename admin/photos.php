                                ...
                                <?php foreach($photos as $photo) : ?>
                                  ...
                                  <tr>
                                    ...
                                    <div class="action_link">
                                        ...
                                        <a href="edit_photo.php?id=<?php echo $photo->id; ?>" class="btn btn-warning btn-sm">Edit</a>
                                        <a href="../photo.php?id=<?php echo $photo->id; ?>" class="btn btn-primary btn-sm">View</a>
